# Script filename: reconstruction_v3.py
...
from odl_utils_v3 import (
    load_json,
    build_global_helical_geometry_v3,
    print_debug,
)


def parse_args() -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Global helical reconstruction prototype v3")

    ap.add_argument("--data_dir", type=str, required=True)
    ap.add_argument("--metadata_path", type=str, default="metadata_v2.json")
    ap.add_argument("--output_dir", type=str, default="reconstruction_v3")
    ...
    # Global ROI for first debugging
    ...
    ap.add_argument("--rec_min_z", type=float, default=0.0)
    ap.add_argument("--rec_max_z", type=float, default=120.0)
...
def main():
    ...
    print_debug("=" * 70)
    print_debug("[INFO] reconstruction_v3.py")
    ...
    geom = build_global_helical_geometry_v3(
    ...
    stem = (
        f"{data_dir.name}_{args.reconstruction_method}_global"
